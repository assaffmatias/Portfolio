        ...
        <div className={styles.container} ref={elementRef[0]}>
            ...
            <li className={styles.li}>
                    ...
                    <label className={styles.label} htmlFor="first">
                        {t('appDeveloper')} @ Haomai Technology
                        <p className={styles.time} >2024-{t('present')}</p>
                    </label>
                    <div className={`${styles.content} ${selectedAccordion === 0 ? styles.open : ''}`}>
                        <div className={styles.description_container}>
                            <div className={styles.logo_container_mobile}>
                                <img src="https://res.cloudinary.com/dth5pbvch/image/upload/v1722094785/1721545368738_uygefy.jpg" alt="" className={styles.logo} />
                            </div>
                            <div className={styles.svg_container}>
                                <div className={styles.svg_content}>
                                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#5dbcca" viewBox="0 0 24 24">
                                ...
                                <div className={styles.svg_content}>
                                    ...
                                    <Link className={styles.link} to={'https://www.haomaitechnology.com/'} target='_blank'>
                                        Haomai.com
                                    </Link>
                                </div>
                            </div>
                            <p className={styles.description}>{t('haomaiDescription')}</p>
                            <div className={styles.button_container}>
                                <button className={styles.button_h}>React Native</button>
                                <button className={styles.button_h}>JavaScript</button>
                                <button className={styles.button_h}>Typescript</button>
                                <button className={styles.button_h}>Nodejs</button>
                                <button className={styles.button_h}>MySQL</button>
                            </div>
                        </div>
                ...
                <li className={styles.li}>
                    ...
                    <label className={styles.label} htmlFor="second">
                        {t('webDeveloper')} @ Softwind Solutions
                        <p className={styles.time} >{t('softwindTime')} 2024</p>
                    </label>
                        ...
                        <div className={styles.description_container}>
                            ...
                            <div className={styles.svg_container}>
                                ...
                                <div className={styles.svg_content}>
                                    ...
                                    <Link className={styles.link} to={'https://softwind.com.ar/'} target='_blank'>
                                        Softwind.com.ar
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className={styles.button_container}>
                                <button className={styles.button_s}>JavaScript</button>
                                <button className={styles.button_s}>Typescript</button>
                                <button className={styles.button_s}>React</button>
                                <button className={styles.button_s}>Tailwind</button>
                            </div>
                        </div>
                        <div className={styles.logo_container}>
                            <img src="https://res.cloudinary.com/dth5pbvch/image/upload/v1718250368/1716477471853-removebg-preview_zykqqp.png" alt="" className={styles.logo} />
