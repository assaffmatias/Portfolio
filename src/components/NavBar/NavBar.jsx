    ...
    return (
        <nav className={styles.container}>
            <div className={styles.main_content}>
                <Link className={`${styles.link} ${pathname === '/' ? styles.current : ''}`} to={'/'} onClick={scroll}>
                ...
                <Link to={'/work'} className={`${styles.link} ${pathname === '/work' ? styles.current : ''}`} onClick={scroll}>
                ...
                <Link className={`${styles.link} ${pathname === '/about' ? styles.current : ''}`} to={'/about'} onClick={scroll}>
                ...
                <Link to={'/contact'} className={`${styles.link} ${pathname === '/contact' ? styles.current : ''}`} onClick={scroll}>
