...
const NavBar = () => {
    ...
    const showBackLink = pathname.startsWith('/work/') && pathname !== '/work';

    return (
        <nav className={styles.container}>
            {pathname === ''}
            <div className={showBackLink ? styles.back_container : styles.hide_back_container}>
                {showBackLink && <Link to={'/work'} className={styles.link_back} onClick={scroll}>
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 12h14M5 12l4-4m-4 4 4 4" />
                    </svg>
                    <div className={styles.tooltip}>{t('back')}</div>
                </Link>}
            </div>
            <div className={styles.main_content}>
                <Link className={styles.link} to={'/'} onClick={scroll}>
                    ...
                    <div className={styles.tooltip}>{t('home')}</div>
                </Link>
                <Link to={'/work'} className={styles.link} onClick={scroll}>
                    ...
                    <div className={styles.tooltip}>{t('portfolio')}</div>
                </Link>
                <Link className={styles.link} to={'/about'} onClick={scroll}>
                    ...
                    <div className={styles.tooltip}>{t('about')}</div>
                </Link>
                <Link to={'/contact'} className={styles.link} onClick={scroll}>
                    ...
                    <div className={styles.tooltip}>{t('contact')}</div>
                </Link>
                <Link className={styles.link} onClick={changeLanguage}>
                    ...
                    <div className={styles.tooltip}>{t('translate')}</div>
                </Link>
            </div>
        </nav>
    )
